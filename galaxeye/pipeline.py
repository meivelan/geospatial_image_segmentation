...
from .preprocessing import (re_labeling, compute_and_save_diff, valid__files,
                             filter_corrupted_valid_files, compute_norm_stats,
                             compute_pos_weight_for_valid, check_corrupted_files)
from .dataset       import (ChangeDetectionDataset, get_loaders,
                             get_test_loader, _loader_kw)
from .model         import get_model
from .train         import train
from .evaluate      import test_model, plot_test_confusion_matrix, visualize_predictions


def run_preprocessing(dataset_root=None):
...
def run_evaluation(dataset_root=None, checkpoint_path=None,
